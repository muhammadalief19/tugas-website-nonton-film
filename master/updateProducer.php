...
$produser = $ProducerController->edit($_GET["id"]);

$success = false;
$failed = false;
if(isset($_POST["submit"])) {
  $result = $ProducerController->update($_GET["id"], $_POST);
  if($result > 0) {
      $success = true;
  } else {
    $failed = true;
...
<div class="navbar bg-base-200 py-6">
  ...
  <div class="modal-box w-max">
    ...
    <p class="py-4">Produser berhasil diupdate !</p>
  ...
  <div class="modal-box w-max">
    ...
    <p class="py-4">Danger, Produser gagal diupdate !</p>
    <div class="modal-action">
          ...
          <div class="w-full h-auto flex flex-col gap-10 justify-center items-center">
            ...
            <form action="" method="post" class="w-full h-auto flex flex-col items-center justify-center gap-6">
                <div class="flex flex-col w-4/5 gap-4">
                    ...
                    <input type="text" name="producer" id="producer" class="input input-bordered input-secondary w-full" value="<?= $produser["nama_produser"] ?>" autocomplete="off">
                </div>
                <button type="submit" name="submit" class="btn btn-active btn-success text-white">
                    Update Produser
                </button>
            </form>
          </div>
